...
```{r}
precision_values <- seq(0.01, .4, length.out = 3000)
post_density <- dgamma(precision_values, 1^2/50^2 + length(weights)/2, 2/5^2 + sum((weights - 50)^2)/2)
...
```{r}
hist(chain[300:n_samples], probability = FALSE)
