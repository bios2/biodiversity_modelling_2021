...
* samplers are rather sensitive to things like starting values, tuning parameters, prior choice etc. What adjustments could you make to this to improve the algorithm? * I chose a VERY large sample size because I want to think about the algorithm itself.  What happens if we choose a more realistic sample size? 

Let's plot this posterior to see how it behaves. Specifically, lets see what kind of lines it thinks are reasonable.
