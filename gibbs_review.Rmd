...
The proposal distribution, centered on a value (e.g. 9) should be the same as the proposal density, centred on the same value.
```{r}
...
# fake some data
set.seed(1859)
weights <- rnorm(1000, mean = 50, sd = 3)
...
I admit that this makes setting reasonable priors awkard, so let's go back to plotting:

```{r}
gs <- rgamma(500, 4^2/3^2, 4/3^2)
